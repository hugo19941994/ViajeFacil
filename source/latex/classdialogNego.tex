...
Estefania Ortego Se definen las funciones de la ventana grafica \hyperlink{classdialogNego}{dialog\+Nego}, se muestra qué hará cada botón o campo que aparezca (en la ventana gráfica). 
\end{DoxyAuthor}
